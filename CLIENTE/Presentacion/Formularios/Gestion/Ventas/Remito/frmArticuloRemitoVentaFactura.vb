...
Public Class frmArticuloRemitoVentaFactura
...
#Region "LOAD"
    ...
    Private Async Sub TmrLoad_Tick(sender As Object, e As EventArgs) Handles tmrLoad.Tick
        ...
        If txtOrigen.Text = "Editar" Then
            ...
            lblCantPendiente.Text = frmRemitoVenta.dgvDetalleRemito.CurrentRow.Cells("CantidadReservada").Value - CountCantidadRemitada(frmRemitoVenta.dgvDetalleRemito.CurrentRow.Cells("idFacturaDetalle").Value) + frmRemitoVenta.dgvDetalleRemito.CurrentRow.Cells("Cantidad").Value
            txtIdFacturaVenta.Text = frmRemitoVenta.dgvDetalleRemito.CurrentRow.Cells("idFactura").Value
            txtIdFacturaVentaDetalle.Text = frmRemitoVenta.dgvDetalleRemito.CurrentRow.Cells("idFacturaDetalle").Value
        ElseIf txtOrigen.Text = "Agregar" Then
            txtCodArt.Text = frmReservaFacturaNuevoCliente.infoDetalleFactura.AscArticulos.CodArticulo
            lblCantPendiente.Text = frmReservaFacturaNuevoCliente.dgvDetalle.CurrentRow.Cells("Saldo").Value
            txtIdFacturaVenta.Text = frmReservaFacturaNuevoCliente.infoDetalleFactura.AscFacturaVenta.IdFacturaVenta
            txtIdFacturaVentaDetalle.Text = frmReservaFacturaNuevoCliente.infoDetalleFactura.IdFacturaVentaDetalle
        End If
    End Sub
#End Region
                ...
                Else
                    ...
                    Else
                        ...
                        Else
                            ...
                            For Each item As DataGridViewRow In frmRemitoVenta.dgvDetalleRemito.Rows
                                If txtIdArticulo.Text = item.Cells("idArticulo").Value And txtPrecioPPal.Text = item.Cells("Precio").Value And txtCodDeposito.Text = item.Cells("idDeposito").Value And txtIdFacturaVentaDetalle.Text = item.Cells("idFacturaDetalle").Value And item.Cells("Origen").Value = "FACTURA" Then
                                    item.SetValues(txtIdArticulo.Text, txtCodDeposito.Text, 0, 0, txtIdFacturaVenta.Text, txtIdFacturaVentaDetalle.Text, txtCodArt.Text,
                                                   txtDetalleArt.Text, lblUndSel.Text, txtPrecioPPal.Text, CDbl(item.Cells("Cantidad").Value) + CDbl(txtCantidad.Text),
                                                   item.Cells("CantidadReservada").Value, lblImpPPal.Text, lblAlicIvaSel.Text, impNeto, txtDeposito.Text, "FACTURA")
                            ...
                            If aggNuevo Then
                                frmRemitoVenta.dgvDetalleRemito.Rows.Add(txtIdArticulo.Text, txtCodDeposito.Text, 0, 0, txtIdFacturaVenta.Text, txtIdFacturaVentaDetalle.Text,
                                                                         txtCodArt.Text, txtDetalleArt.Text, lblUndSel.Text, txtPrecioPPal.Text, txtCantidad.Text,
