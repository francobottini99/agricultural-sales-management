...
Public Class frmArticuloRemitoVentaNuevo
            ...
            Else
                ...
                Else
                    ...
                    Else
                        ...
                        For Each item As DataGridViewRow In frmRemitoVenta.dgvDetalleRemito.Rows
                            If txtIdArticulo.Text = item.Cells("idArticulo").Value And txtPrecioPPal.Text = item.Cells("Precio").Value And txtCodDeposito.Text = item.Cells("idDeposito").Value And item.Cells("Origen").Value = "NUEVO" Then
                                item.SetValues(txtIdArticulo.Text, txtCodDeposito.Text, 0, 0, 0, 0, txtCodArt.Text, txtDetalleArt.Text, lblUndSel.Text, txtPrecioPPal.Text,
                        ...
                        If aggNuevo Then
                            frmRemitoVenta.dgvDetalleRemito.Rows.Add(txtIdArticulo.Text, txtCodDeposito.Text, 0, 0, 0, 0, txtCodArt.Text, txtDetalleArt.Text, lblUndSel.Text, txtPrecioPPal.Text,
