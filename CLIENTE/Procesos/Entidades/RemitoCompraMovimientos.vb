Public Class RemitoCompraMovimientos
    ...
    Private _ascDetalleRemtioCompra As DetalleRemitoCompra
    Private _ascStock As Stock

#Region "CONSTRUCTORES"
    Public Sub New()
        AscUsuarios = New Usuario()
        AscDetalleRemtioCompra = New DetalleRemitoCompra()
        AscStock = New Stock()
    End Sub

    Public Sub New(idRemitosCompraMovimientos As Integer, fecha As Date, tipo As String, cantidad As Double, eliminado As String,
                   ascUsuarios As Usuario, ascDetalleRemtioCompra As DetalleRemitoCompra, ascStock As Stock)
...
#Region "PROPIEDADES"
    ...
    Public Property AscDetalleRemtioCompra As DetalleRemitoCompra
        Get
            Return _ascDetalleRemtioCompra
        End Get
        Set(value As DetalleRemitoCompra)
