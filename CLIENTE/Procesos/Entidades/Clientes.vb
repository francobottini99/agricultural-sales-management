...
#Region "CONSTRUCTORES"
    ...
    Public Sub New(idCliente As Integer, fechaAlta As Date, razonSocial As String, direccion As String, localidad As String,
                   provincia As String, codPostal As String, pais As String, telefono As String, mail As String, web As String,
                   cUIT As String, iIBB As String, situacionIVA As String, creditoAsignado As Double, creditoConsumido As Double,
                   estado As String, clasificacion As String, eliminado As String, ascUsuarios As Usuario)
    ...
    Public Sub New(fechaAlta As Date, razonSocial As String, direccion As String, localidad As String,
                   provincia As String, codPostal As String, pais As String, telefono As String, mail As String, web As String,
                   cUIT As String, iIBB As String, situacionIVA As String, creditoAsignado As Double, clasificacion As String)
        Me.FechaAlta = fechaAlta
        Me.RazonSocial = razonSocial
        Me.Direccion = direccion
        Me.Localidad = localidad
