...
Public Class TareasRemitoVentaMovimientos
...
#Region "METODOS PUBLICOS ACCESO A COMUNICACIONES"
    Public Async Function ListadoPorIdRemitoVenta(id As Integer) As Task(Of List(Of RemitoVentaMovimientos))
        Try
            Dim list As New List(Of RemitoVentaMovimientos)

            For Each item In Await Transaccion.verRegistrosPorIdRemitosVenta(id)
                list.Add(Drivers.RemitosVentaMovimientos(item))
            Next
